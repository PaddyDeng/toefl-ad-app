...
public class GeneralKnowView extends RelativeLayout {
    ...
    public GeneralKnowView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GeneralKnowView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        public void resize(final float height) {
            ((BaseActivity) mContext).runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    webView.setLayoutParams(new LayoutParams(getResources().getDisplayMetrics().widthPixels,
...
//                                startActivity(intent);
                            ...
                            case 1:
                                Utils.toastShort(mContext, "二维码识别结果: "+ result.toString());
//                                Intent intent = new Intent(Intent.ACTION_VIEW);
//                                intent.setData(Uri.parse(result.toString()));
//                                startActivity(intent);
