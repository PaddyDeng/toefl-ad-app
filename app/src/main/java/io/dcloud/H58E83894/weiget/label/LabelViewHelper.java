package io.dcloud.H58E83894.weiget.label;
...
public final class LabelViewHelper {
    ...
    public LabelViewHelper(Context context, AttributeSet attrs) {
        ...
        mTopPadding = typedArray.getDimension(R.styleable.LabelView_labelTopPadding,
                context.getResources().getDimensionPixelSize(R.dimen.border_space_sec));
        ...
        mBottomPadding = typedArray.getDimension(R.styleable.LabelView_labelBottomPadding,
                context.getResources().getDimensionPixelSize(R.dimen.border_space_sec_max));
        ...
        mTextTitleSize = typedArray.getDimension(R.styleable.LabelView_textTitleSize,
                context.getResources().getDimensionPixelSize(R.dimen.text_size_micro));
    ...
    public void setRouteDegrees(int mRouteDegrees) {
        this.mRouteDegrees = mRouteDegrees;
    }
