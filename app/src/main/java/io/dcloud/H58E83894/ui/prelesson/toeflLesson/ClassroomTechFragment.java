...
//面授课
public  class ClassroomTechFragment extends BaseFragment {
    ...
    protected View onCreateViewInit(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return  inflater.inflate(R.layout.fragment_record_base, container, false);
    }
