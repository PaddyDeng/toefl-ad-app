...
public class SpeakCorretAdapter extends RecyclerView.Adapter<BaseRecyclerViewHolder> {
    ...
    public SpeakCorretAdapter(List<TodayListData.DataBean> share, Context context, RxPermissions rxPermissions) {
        this.share = share;
