...
public class GlideUtil {
    ...
    public static void load(Object obj, ImageView imageView) {
        loadDefault(obj, imageView, false, DecodeFormat.PREFER_ARGB_8888, DiskCacheStrategy.RESULT);
    }

    public static void loadAsGif(Object obj,ImageView imageView){
        loadDefault(obj, imageView, true, DecodeFormat.PREFER_ARGB_8888, DiskCacheStrategy.RESULT);
    }

    public static void loadNoDefalut(Object obj, ImageView imageView) {
        loadNoDefault(obj, imageView, false, DecodeFormat.PREFER_ARGB_8888, DiskCacheStrategy.RESULT);
    }
    ...
    public static void loadDefaultOverrideNoAnim(Object loadObj, ImageView imageView, int overrideW, int overrideH, Boolean asGif, DecodeFormat format, DiskCacheStrategy diskcacheStrategy) {
        load(imageView.getContext(), loadObj, imageView, overrideW, overrideH, R.drawable.icon_default, R.drawable.icon_default, 0, asGif, format, null, diskcacheStrategy);
    }
    ...
    public static void loadDefaultTransformation(Object loadObj, ImageView imageView, Boolean asGif, DecodeFormat format, Transformation transformation, DiskCacheStrategy diskcacheStrategy) {
        load(imageView.getContext(), loadObj, imageView, 0, 0, R.drawable.icon_default, R.drawable.icon_default, R.anim.image_load, asGif, format, transformation,
                diskcacheStrategy);
    }
    ...
    public static void loadDefault(Object loadObj, ImageView imageView, Boolean asGif, DecodeFormat format, DiskCacheStrategy diskcacheStrategy) {
        load(imageView.getContext(), loadObj, imageView, 0, 0, R.drawable.icon_default, R.drawable.icon_default, R.anim.image_load, asGif, format, null, diskcacheStrategy);
    }

    public static void loadNoDefault(Object loadObj, ImageView imageView, Boolean asGif, DecodeFormat format, DiskCacheStrategy diskcacheStrategy) {
        load(imageView.getContext(), loadObj, imageView, 0, 0, 0, 0, R.anim.image_load, asGif, format, null, diskcacheStrategy);
    }
    ...
    public static void loadDefaultNoAnim(Object loadObj, ImageView imageView, Boolean asGif, DecodeFormat format, DiskCacheStrategy diskcacheStrategy) {
        load(imageView.getContext(), loadObj, imageView, 0, 0, R.drawable.icon_default, R.drawable.icon_default, 0, asGif, format, null, diskcacheStrategy);
    }
