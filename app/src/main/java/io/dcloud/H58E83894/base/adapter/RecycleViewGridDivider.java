...
/**
 * 不画最后一行和第一行，第一列和最后一列
 * Created by better on 2017/2/23 10:38.
 */
...
public class RecycleViewGridDivider extends RecyclerView.ItemDecoration {
    ...
    public RecycleViewGridDivider(Context context, int drawableId) {
        if (0 != drawableId) {
